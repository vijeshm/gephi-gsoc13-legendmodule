...
public class AttributeFactoryImpl implements AttributeValueFactory, AttributeRowFactory {
    ...
    public AttributeValue newValue(AttributeColumn column, AttributeRow row, Object value) {
        ...
        if (value == null) {
            attributeValue = new AttributeValueImpl((AttributeColumnImpl) column, row, null);
        } else {
            ...
            attributeValue = new AttributeValueImpl((AttributeColumnImpl) column, row, managedValue);
        }
    ...
    public AttributeRowImpl newRowForTable(String tableName, Attributable source) {
        AttributeTableImpl attTable = model.getTable(tableName);
        if (attTable != null) {
            return new AttributeRowImpl(attTable, source);
        }
        return null;
    }
